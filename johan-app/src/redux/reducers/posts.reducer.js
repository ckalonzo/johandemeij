...
export default function postsReducer (state = initialState, action) {
    switch (action.type) {
      ...
      case ACTIONS.LOAD_POSTS: {
       ...
       fetch('http://132.148.157.71:5021/api/api/loadPosts')
        .then((data) => data.json())
        .then((res) => {
      ...
      case ACTIONS.LOAD_POSTS_SUCCESS: {
        ...
        let imageName = []
        fetch('http://132.148.157.71:5021/api/api/loadPostImages')
            .then((data) => data.json())
            .then((res) => {
      ...
      case ACTIONS.LOAD_DASHBOARD_POSTS: {
        ...
        fetch('http://132.148.157.71:5021/api/api/loadAllPosts')
         .then((data) => data.json())
         .then((res) => {
